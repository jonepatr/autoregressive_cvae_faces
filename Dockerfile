...
RUN apt-get update
RUN apt-get install -y libsndfile1 wget cmake build-essential tmux
...
RUN pip install luigi librosa pysoundfile pytube ruffus beautifulsoup4 pandas dlib docker-py matplotlib pytorch_lightning pylint black torchcontrib pdbpp jupyter
